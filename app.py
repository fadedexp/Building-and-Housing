...
sns.barplot(df[tenYears1][['Estimated Cost', 'Revised Cost']], ci=None, ax=ax0)
sns.barplot(df[tenYears2][['Estimated Cost', 'Revised Cost']], ci=None, ax=ax1)
sns.barplot(df[tenYears3][['Estimated Cost', 'Revised Cost']], ci=None, ax=ax2)
sns.barplot(df[tenYears4][['Estimated Cost', 'Revised Cost']], ci=None, ax=ax3)
